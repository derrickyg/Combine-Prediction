...
class MLP:
    def __init__(self, input_dim, hidden_dim1, hidden_dim2, leak=0.01):
    ...
    def forward(self, X):
        ...
        self.h2 = self.leaky_relu(self.z2)
    ...
    def backward(self, X, y, y_pred, lr):
        ...
        dh2 = dz3 @ self.W3.T
        dz2 = dh2 * self.leaky_relu_deriv(self.z2)
        dW2 = self.h1.T @ dz2 / n
...
if __name__ == "__main__":
    ...
    print("MLP Input Feature Importances (abs sum of W1):")
    for f, w in zip(features, feature_weights):
        print(f"{f:<25}: {w:.4f}")
